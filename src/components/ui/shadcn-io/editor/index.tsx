    ...
    CodeBlockLowlight.configure({
      ...
      HTMLAttributes: {
        class: cn(
          ...
          "[&_.hljs-meta_.hljs-string]:text-[#032f62] dark:[&_.hljs-meta_.hljs-string]:text-[#FADD1E] [&_.hljs-regexp]:text-[#032f62] dark:[&_.hljs-regexp]:text-[#FADD1E] [&_.hljs-string]:text-[#032f62] dark:[&_.hljs-string]:text-[#a06f5a]",
